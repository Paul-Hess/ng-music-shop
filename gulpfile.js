...
- install globals if needed (gulp, bower, sass, typescript, typescript packages.)
  ...
  - tsd moment --save // Moment typescript definition. Use this same format for other type definitions.
  - add this at the top of your file /// <reference path="moment.d.ts"/> so that typescript recognizes moment
- gulp build
- gulp serve
*/
